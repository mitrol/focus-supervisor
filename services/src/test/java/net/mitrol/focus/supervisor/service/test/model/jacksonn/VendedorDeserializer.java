...
public class VendedorDeserializer extends JsonDeserializer<HashMap<AgentState, Duration>> {
    ...
    @Override
    public HashMap<AgentState, Duration> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        data.put(AgentState.NOT_READY, duration);
        return data;
    }
}
